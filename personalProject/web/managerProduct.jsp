...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .products-img img {
                max-width: 200px; /* Đặt chiều rộng tối đa của ảnh */
                max-height: 200px; /* Đặt chiều cao tối đa của ảnh */
                display: block; /* Để hỗ trợ căn chỉnh trung tâm */
                /*margin: auto  Căn chỉnh ảnh vào giữa cột */
            }
        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <h2 style="display: inline-block">/Manage <b>Product</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <!--Href xác định mục tiêu cho modal, nó không ảnh hưởng đến URL trình duyệt.-->
                        ...
                        <tbody>
                           ...
                           if (listP != null) {
                            ...
                            <tr>
                                ...
                                <td><%=p.getId()%></td>
                                <td><%=p.getName()%></td>
                                <td class="products-img"><img src="<%=p.getImage()%>" alt="alt"/></td>
                                <td>$<%=p.getPrice()%></td>
                                <td>
                                    <a href="edit?pid=<%=p.getId()%>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#deleteEmployeeModal" class="delete" onclick="confirmDelete('<%=p.getId()%>')" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                            <%
                                       }
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Showing <b>${total >5 ? 5 : total}</b> out of <b>${total}</b> entries</div>
                        <ul class="pagination">
                            <c:if test="${tag > 1}"> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="delete" method="post">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="pid" id="deleteProductId"> <!-- Hidden input to store product ID -->
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
...
//            function openEditModal(productId, productName, productImage, pPrice, productTitle, pDescription) {
...
//                document.getElementById("editProductDescription").value = pDescription;
//            }
